...
const EntityInfo entity_bathroom_sink{1, 1, 48, {0.0f, 0.0f, 0.0001f, 0.0f, 0.0f}, 1, Action_WashHands};
const EntityInfo entity_bathroom_toilet{1, 1, 52, {0.0f, 0.0f, -0.0001f, 0.005f, 0.0f}, 0, Action_Toilet};
